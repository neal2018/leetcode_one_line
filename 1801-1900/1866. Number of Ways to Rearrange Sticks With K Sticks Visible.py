class Solution:
    def rearrangeSticks(self, n: int, k: int) -> int:
        return (lambda n, k: (lambda MOD: (lambda f, n, k: f(f, n, k))(lru_cache(None)(lambda f, n, k: 1 if n == k else 0 if k == 0 else (f(f, n - 1, k - 1) + f(f, n - 1, k) * (n - 1)) % MOD), n, k))(10**9 + 7))(n, k)
...
class Solution:
    def rearrangeSticks(self, n: int, k: int) -> int:
        return (lambda n, k:
                (lambda MOD:  # variable MOD to save 10**9 + 7
